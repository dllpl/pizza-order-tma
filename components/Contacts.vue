...
const data = ref(props.contactData)
    ...
    <form class="max-w-md mx-auto">
        <div class="grid grid-cols-2 gap-4 md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5 group">
                <input v-model="data.first_name" type="text" name="first_name" id="first_name"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input v-model="data.last_name" type="text" name="last_name" id="last_name"
                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                       placeholder=" " required/>
                <label for="last_name"
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input v-model="data.phone_number" type="tel" name="phone" id="phone"
                   class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                   placeholder=" " required/>
            <label for="phone"
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input v-model="address" type="tel" name="address" id="address"
                   class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                   placeholder=" " required/>
            <label for="address"
